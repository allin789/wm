...
static const char *fonts[]          = { "DroidFontMono:size=12", "DroidFontMono:size=12" };
...
static const char col_cyan[]        = "#9b1ac9";
...
static const char *dmenucmd[] = { "dmenu_run", "-fn", "Droid Sans Mono-13", NULL };
